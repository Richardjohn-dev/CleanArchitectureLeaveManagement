...
using CleanArchitecture.LeaveManagement.Persistence;
...
namespace CleanArchitecture.LeaveManagement.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CleanArchitecture.LeaveManagement.Api", Version = "v1" });
            });
